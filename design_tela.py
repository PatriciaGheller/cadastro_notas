...
tabela = ttk.Treeview(janela, columms=("Nome", "Nota1", "Nota2", "Média", "Situação"), show="headings")
...
scrolbar = tkk.Scrolbar(janela, orient="vertical", command=tabela.yview)
tabela.configure(yscrollcommand=scrolbar.set)
